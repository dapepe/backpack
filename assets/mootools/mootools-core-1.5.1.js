...
web build:
 - http://mootools.net/core/ca9253293005745a3a96d91e960a4d91

packager build:
 - packager build Core/Element.Delegation Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request Core/Cookie Core/JSON Core/DOMReady
...
}});Function.extend({attempt:function(){for(var b=0,a=arguments.length;b<a;b++){try{return arguments[b]();}catch(c){}}return null;}});Function.implement({attempt:function(a,c){try{return this.apply(c,Array.from(a));
}catch(b){}return null;},bind:function(e){var a=this,b=arguments.length>1?Array.slice(arguments,1):null,d=function(){};var c=function(){var g=e,h=arguments.length;
if(this instanceof c){d.prototype=a.prototype;g=new d;}var f=(!b&&!h)?a.call(g):a.apply(g,b&&h?b.concat(Array.slice(arguments)):b||arguments);return g==e?f:g;
};return c;},pass:function(b,c){var a=this;if(b!=null){b=Array.from(b);}return function(){return a.apply(c,b||arguments);};},delay:function(b,c,a){return setTimeout(this.pass((a==null?[]:a),c),b);
...
};}});Number.implement(a);})(["abs","acos","asin","atan","atan2","ceil","cos","exp","floor","log","max","min","pow","sin","sqrt","tan"]);String.implement({contains:function(b,a){return(a?String(this).slice(a):String(this)).indexOf(b)>-1;
...
}return(a[c]!=null)?a[c]:"";});}});(function(){var f=this.document;var d=f.window=this;var a=function(k,e){k=k.toLowerCase();e=(e?e.toLowerCase():"");var l=k.match(/(opera|ie|firefox|chrome|trident|crios|version)[\s\/:]([\w\d\.]+)?.*?(safari|(?:rv[\s\/:]|version[\s\/:])([\w\d\.]+)|$)/)||[null,"unknown",0];
...
},get:function(){return this.id||null;},erase:function(){this.id=this.getAttributeNode("id").value="";}};}})();(function(){var c={};var b=function(e){var f;
if(e.wheelDelta){f=e.wheelDelta%120==0?e.wheelDelta/120:e.wheelDelta/12;}else{var d=e.deltaY||e.detail||0;f=-(d%3==0?d/3:d*10);}return f;};var a=this.DOMEvent=new Type("DOMEvent",function(d,h){if(!h){h=window;
}d=d||h.event;if(d.$extended){return d;}this.event=d;this.$extended=true;this.shift=d.shiftKey;this.control=d.ctrlKey;this.alt=d.altKey;this.meta=d.metaKey;
var j=this.type=d.type;var i=d.target||d.srcElement;while(i&&i.nodeType==3){i=i.parentNode;}this.target=document.id(i);if(j.indexOf("key")==0){var e=this.code=(d.which||d.keyCode);
...
})();(function(){var h=document.html,a;a=document.createElement("div");a.style.color="red";a.style.color=null;var m=a.style.color=="red";var k="1px solid #123abc";
a.style.border=k;var l=a.style.border!=k;a=null;var d=!!window.getComputedStyle,i=document.createElement("div").style.borderRadius!=null;Element.Properties.styles={set:function(s){this.setStyles(s);
}};var e=(h.style.opacity!=null),p=(h.style.filter!=null),r=/alpha\(opacity=([\d.]+)\)/i;var j=function(t,s){t.store("$opacity",s);t.style.visibility=s>0||s==null?"visible":"hidden";
};var c=function(s,w,v){var u=s.style,t=u.filter||s.getComputedStyle("filter")||"";u.filter=(w.test(t)?t.replace(w,v):t+" "+v).trim();if(!u.filter){u.removeAttribute("filter");
}};var o=(e?function(t,s){t.style.opacity=s;}:(p?function(t,s){if(!t.currentStyle||!t.currentStyle.hasLayout){t.style.zoom=1;}if(s==null||s==1){c(t,r,"");
if(s==1&&f(t)!=1){c(t,r,"alpha(opacity=100)");}}else{c(t,r,"alpha(opacity="+(s*100).limit(0,100).round()+")");}}:j));var f=(e?function(t){var s=t.style.opacity||t.getComputedStyle("opacity");
...
}}return eval("("+string+")");};})();(function(i,k){var l,f,e=[],c,b,d=k.createElement("div");var g=function(){clearTimeout(b);if(!l){Browser.loaded=l=true;
k.removeListener("DOMContentLoaded",g).removeListener("readystatechange",a);k.fireEvent("domready");i.fireEvent("domready");}k=i=d=null;};var a=function(){for(var m=e.length;
